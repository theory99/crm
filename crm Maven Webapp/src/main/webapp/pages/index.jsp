...
<html>
  <head>
	...
	<link href="<%=basePath%>pages/css/default.css" rel="stylesheet" type="text/css" />
    <link rel="stylesheet" type="text/css" href="<%=basePath%>pages/js/themes/default/easyui.css" />
    <link rel="stylesheet" type="text/css" href="<%=basePath%>pages/js/themes/icon.css" />
    <script type="text/javascript" src="<%=basePath%>pages/js/jquery-1.4.2.min.js"></script>
    <script type="text/javascript" src="<%=basePath%>pages/js/jquery.easyui.js"></script>

	<script type="text/javascript" src="<%=basePath%>pages/js/outlook2.js"> </script>
...
<div style=" position:absolute; z-index:100000; height:2046px;top:0px;left:0px; width:100%; background:white; text-align:center;">
    <img src="pages/images/noscript.gif" alt='抱歉，请开启脚本支持！' />
</div></noscript>
    <div region="north" split="true" border="false" style="overflow: hidden; height: 50px;
        background: url(pages/images/layout-browser-hd-bg.gif) #7f99be repeat-x center 50%;
        ...
        <span style="padding-left:10px; font-size: 16px; "><img src="<%=basePath%>pages/images/blocks.gif" width="20" height="20" align="absmiddle" /> 农夫it站www.nongfuit.com</span>
    </div>
